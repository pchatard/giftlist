...
/* prettier-ignore */
export type GiftDTO = Pick<Gift, "id" | "title"	| "isBooked" | "bookedByDTO" | "isBookedByMe" | "isFavorite"	| "isHidden"	| "category"	| "listId"	| "price"	| "linkURL"	| "brand"	| "size"	| "color"	| "comments">;
/* prettier-ignore */
export interface GiftDTOForOwner extends Expand<Omit<GiftDTO, "isBooked" | "bookedBy" | "bookedByDTO" | "isBookedByMe" | "listId" | "list">> {}
